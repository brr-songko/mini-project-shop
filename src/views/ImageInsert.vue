  ...
  <div class="container">
    ...
    <div class="mb-3 row">
      ...
      <div class="col-md-9">
        ...
        <input type="file" class="form-control" accept="image/png,image/jpeg"
               @chnage="uplaodFile($event.target.file, 1)">
    ...
    <div class="mb-3 row">
      ...
      <div class="col-md-9">
        ...
        <input type="file" class="form-control" accept="image/png,image/jpeg"
               @change="uploadFile($event.target.file, 2)">
        <div class="alert alert-secondary" role="alert">
          <ul>
            <li>최대 5개 가능</li>
      ...
      <div class="col-md-9">
        <div class="row">
          <div class="col-lg-6 col-md-8">
            <input type="file" class="form-control" accept="image/png,image/jpeg"
                   @change="uploadFile($event.target.file, 3)">
            <div class="alert alert-secondary" role="alert">
              <ul>
                <li>파일 사이즈 : 5M 이하</li>
                <li>파일 확장자 : png, jpg만 가능</li>
          ...
          <div class="col-lg-6 col-md-4" :key="i" v-for="(m,i) in productImage.fileter(c=>c.type==3)">
            <div class="position-relative">
              <img :src="`/download/${productId}/${m.path}`" class="img-fluid"/>
              <div class="position-absolute top-0 end-0" style="cursor:pointer;color:white;" @click="deleteImage(m.id)">
                X
              </div>
            </div>
          </div>
